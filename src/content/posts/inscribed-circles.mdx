...
$$
\begin{align*}
\int_{0}^{\frac{r}{2}} \sqrt{r^2 - \left(x-\frac{r}{2}\right)^2} \ dx &= \frac{1}{2}\left(x - \frac{r}{2}\right) \sqrt{r^2 - \left(x-\frac{r}{2}\right)^2} + \frac{r^2}{2} \sin^{-1}\left(\frac{x-\frac{r}{2}}{r}\right) \bigg|_{0}^{\frac{r}{2}} \\
&= \left[0\right] - \left[-\frac{1}{2}\frac{\sqrt{3}r^2}{4}  +  \frac{r^2}{2}\sin^{-1}\left(-\frac{1}{2}\right)\right] \\
&= -\frac{r^2}{2}\left(\sin^{-1}\left(-\frac{1}{2}\right) - \frac{\sqrt{3}}{4}\right) \\
\end{align*}
$$
...
$$
\begin{align}
\text{Area} &= 2\left[\frac{r^2}{2} + \frac{r^2}{2}\left(\sin^{-1}\left(-\frac{1}{2}\right) - \frac{\sqrt{3}}{4}\right)\right] \\
&= 2\left[\frac{r^2}{2}\left(1 - \frac{\sqrt{3}}{4} - \sin^{-1}\left(\frac{1}{2}\right)\right)\right] \\
&= r^2\left(1 - \frac{\sqrt{3}}{4} - \sin^{-1}\left(\frac{1}{2}\right)\right) \ \square\\
\end{align}
$$
...
$$
\theta = 2\cos^{-1}\left(\frac{h}{r}\right) \Rightarrow s = 2r\cos^{-1}\left(\frac{h}{r}\right)
$$
...
$$
\begin{align}
\text{Area of chord } AC &= \frac{1}{2} r^2 \left( \frac{2r\cos^{-1}\left(\frac{h}{r}\right)}{r} - \frac{a}{2r^2} \sqrt{4r^2 - a^2} \right) \\
&= \frac{1}{2} r^2 \left( 2\cos^{-1}\left(\frac{h}{r}\right) - \frac{a}{2r^2} \sqrt{4r^2 - a^2} \right) \\
&= r^2\cos^{-1}\left(\frac{h}{r}\right) - \frac{1}{4} a \sqrt{4r^2 - a^2} \\
&= r^2\cos^{-1}\left(\frac{h}{r}\right) - h\sqrt{r^2 - h^2} \\
\end{align}
$$
...
\begin{align}
\text{Area of } C_{cropped} &= \text{Area of semicircle } C_1 - \text{Area of chord } AC \\
&= \frac{1}{2} \pi r^2 - \left(r^2\cos^{-1}\left(\frac{h}{r}\right) - h\sqrt{r^2 - h^2}\right) \\
&= \frac{1}{2} \pi r^2 - r^2\cos^{-1}\left(\frac{h}{r}\right) + h\sqrt{r^2 - h^2} \\
\end{align}
$$
...
\begin{align}
\text{Area} &= \text{Area of } B - \text{Area of } C_{cropped} \\
&= r^2 - \left(\frac{1}{2} \pi r^2 - r^2\cos^{-1}\left(\frac{h}{r}\right) + h\sqrt{r^2 - h^2}\right) \\
&= r^2\left(1 - \frac{\pi}{2} + \cos^{-1}\left(\frac{h}{r}\right)\right) - h\sqrt{r^2 - h^2}\\
\end{align}
$$
...
$$
\begin{align}
\text{Area} &= r^2\left(1 - \frac{\pi}{2} + \cos^{-1}\left(\frac{1}{2}\right)\right) - \frac{r}{2}\sqrt{r^2 - \left(\frac{r}{2}\right)^2} \\
&= r^2\left(1 - \frac{\pi}{2} + \cos^{-1}\left(\frac{1}{2}\right)\right) - \frac{\sqrt{3}r^2}{4}
\end{align}
$$
...
$$
\sin^{-1}x + \cos^{-1}x = \frac{\pi}{2} \Rightarrow \cos^{-1}x = \frac{\pi}{2} - \sin^{-1}x
$$

$$
\text{Area} = r^2\left(1 - \frac{\sqrt{3}}{4} - \sin^{-1}\left(\frac{1}{2}\right)\right) \square
$$
